...
//                            }
                            ...
                            /**
                             * This method combines two Indices, PLIs to one
                             * (index, pli)
                             */
                            private Tuple2<BitSet, List<LongArrayList>> combine(
                                ...
                                BitSet newColumCombination = (BitSet) outer._1
                                        .clone();
     ...
     */
    private static boolean isSubsetUnique(BitSet columnCombination, Set<BitSet> minUCC) {
